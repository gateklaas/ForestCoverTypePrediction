"""
Calculates the accuracy_score of the machine learning algorithms
"""
...
lc.print_accuracy(test_y, clf.predict(test_X))

clf = SVC(kernel="rbf", C=2.7, gamma=0.55, cache_size=1000)
clf.fit(train_X, train_y)
